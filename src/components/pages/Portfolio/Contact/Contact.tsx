...
const Contact = () => {
  return (
    <section className="grid w-full place-items-center bg-[#EEEFCF] px-5 py-20 lg:p-10 lg:py-32">
      <div className="container grid h-full w-full grid-cols-1 place-items-center gap-14 lg:grid-cols-2 lg:gap-0">
        <div className="flex flex-col items-center gap-14 text-center text-tertiary-main lg:items-start lg:text-left">
